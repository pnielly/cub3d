...
/*   Updated: 2020/02/05 12:45:35 by pnielly          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	if (argc == 3 && !ft_strncmp(argv2, "-save", 5))
//		ft_screenshot(stock);
	free(argv2);
	ft_events(stock);
	return (0);
