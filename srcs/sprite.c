...
/*   Updated: 2020/02/25 17:24:35 by pnielly          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (stock->map->tab[(int)(stock->player->pos_y + 0.1)]
			[(int)stock->player->pos_x] == '2'
			&& stock->map->tab[(int)(stock->player->pos_y + 1.1)]
			[(int)stock->player->pos_x] == '0')
	{
		stock->map->tab[(int)(stock->player->pos_y + 0.1)]
			[(int)stock->player->pos_x] = '0';
		stock->map->tab[(int)(stock->player->pos_y + 1.1)]
			[(int)stock->player->pos_x] = '2';
	}
...
void	ft_move_sprite(t_stock *stock)
{
	if (stock->map->tab[(int)stock->player->pos_y]
			[(int)(stock->player->pos_x + 0.1)] == '2'
			&& stock->map->tab[(int)stock->player->pos_y]
			[(int)(stock->player->pos_x + 1.1)] == '0')
	{
		stock->map->tab[(int)stock->player->pos_y]
			[(int)(stock->player->pos_x + 0.1)] = '0';
		stock->map->tab[(int)stock->player->pos_y]
			[(int)(stock->player->pos_x + 1.1)] = '2';
	}
	if (stock->map->tab[(int)stock->player->pos_y]
			[(int)(stock->player->pos_x - 0.1)] == '2'
			&& stock->map->tab[(int)stock->player->pos_y]
