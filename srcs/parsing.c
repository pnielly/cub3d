...
/*   Updated: 2020/02/25 19:23:03 by pnielly          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_check_assign(int i, int j, t_stock *stock)
{
	...
	if (!ft_strchr("01234NSEW", stock->map->tab[j][i]))
