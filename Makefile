...
#    Updated: 2020/02/25 12:33:09 by pnielly          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# srcs files
SRC = main.c game.c events.c check_map.c check_map2.c color.c raycasting.c move.c parsing.c screen.c utils.c init_struct.c image_tex.c save.c sprite.c draw_sprite.c free.c hud.c
