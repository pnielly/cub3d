...
#    Updated: 2020/03/03 12:37:27 by pnielly          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# srcs files
SRC = main.c game.c events.c check_map.c check_map2.c check_map3.c color.c raycasting.c move.c parsing.c screen.c utils.c init_struct.c image_tex.c save.c sprite.c draw_sprite.c free.c hud.c lost_won.c
