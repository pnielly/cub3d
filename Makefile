...
#    Updated: 2020/02/01 16:15:23 by pnielly          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# srcs files
SRC = main.c game.c events.c check_map.c color.c raycasting.c move.c parsing.c screen.c utils.c init_struct.c image_tex.c save.c sprite.c
